...
void stringLCD4(char text[], int length,int line, int pos); //Prints string to LCD using 4-bit instructions
void stringLCD8(char text[], int length,int line, int pos); //Prints string to LCD using 8-bit instructions
